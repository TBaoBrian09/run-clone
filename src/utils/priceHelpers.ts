...
async function calcSell( tokenAddres: string){
    const web3 = new Web3(process.env.REACT_APP_NODE_1 || BSC_NODE);
    const BNBTokenAddress = "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c";

    const router = await new web3.eth.Contract( pancakeSwapAbi as AbiItem[], addresses.pancakeRouter[56] );
