...
import { Text, Modal, useModal, InjectedModalProps, Link } from '@phamphu19498/runtogether-uikit'
...
export default function UnsupportedCurrencyFooter({ currencies }: { currencies: (Currency | undefined)[] }) {
  ...
  return (
    <DetailsFooter>
      <Button variant="primary" onClick={onPresentModal} width="100%" style={{borderRadius:"10px"}}>
