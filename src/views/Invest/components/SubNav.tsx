    ...
    <Wrapper>
        <CsStyledNav>
          <WrapLink style={activeIndex === 0 ? styleActive : defaultStyle}>
            <CustomNavLink style={activeIndex === 0 ? styleActive : defaultStyle} to="/investtogether" aria-hidden="true">
              <Strong>{t('Pools Store')}</Strong>
            </CustomNavLink>
          </WrapLink>
          <WrapLink style={activeIndex === 1 ? styleActive : defaultStyle}>
            <CustomNavLink style={activeIndex === 1 ? styleActive : defaultStyle} to="/proposals" aria-hidden="true">
