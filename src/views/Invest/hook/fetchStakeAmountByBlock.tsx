...
export const GetStakeAmountByBlock =  (contractAddress,callback,poolLength) =>{
    ...
    useEffect(()=>{
         const getStakeAmountByBlock = async ()=>{
             try {
                 ...
                 const [resultStakeAMount] = await multicall(poolStoreAbi, calls);                 
    ...
    },[contractAddress,account,callback,poolLength])
