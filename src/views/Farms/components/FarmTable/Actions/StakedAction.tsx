...
import {  Skeleton, Text, Heading } from 'components/Pancake-uikit'
import { Button, IconButton, AddIcon, MinusIcon, useModal } from '@phamphu19498/runtogether-uikit'
      ...
      return (
        <CustomActionContainer>
          ...
          <ActionContent>
            ...
            <IconButtonWrapper>
              <IconButton variant="tertiary" onClick={onPresentWithdraw} mr="6px" disabled={!timeCanStake}>
