  ...
  return (
    <ExpandedWrapper flexDirection="column">
      ...
      {/* <Flex mb="2px" justifyContent="flex-end">
        <StyleLinkExternal href={`https://pancakeswap.info/token/${getAddress(earningToken.address)}`} bold={false} small>
          {t('See Token Info')}
        </StyleLinkExternal>
      </Flex> */}
      {/* <Flex mb="2px" justifyContent="flex-end">
        <StyleLinkExternal href={earningToken.projectLink} bold={false} small>
          {t('View Project Site')}
        </StyleLinkExternal>
      </Flex> */}
      {poolContractAddress && (
      ...
      {account && isMetaMaskInScope && tokenAddress && (
        <Flex justifyContent="flex-end">
          ...
          >
            <StyleText color="primary" fontSize="14px">
              {t('Add to Metamask')}
            </StyleText>
            <MetamaskIcon ml="4px" />
          </Button>
