...
const AutoHarvestAction: React.FunctionComponent<AutoHarvestActionProps> = ({ userDataLoaded, earningTokenPrice }) => {
  ...
  const actionTitle = (
    <Text fontSize="12px" bold color="primaryBright" as="span" textTransform="uppercase">
  ...
  return (
    <ActionContainer isAutoVault>
      ...
      <ActionContent>
        ...
        <Flex flex="1" flexDirection="column" alignSelf="flex-start" alignItems="flex-start">
