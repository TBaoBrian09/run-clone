...
const GroupMenu = () => {
	...
	return(
		<>
			<GroupButtom>
				<Button onClick={() => {handleChangeGroup(1)}} style={groupMenu === 1 ? styleActive : {}} className="left-button" variant="text">NFTs Farm</Button>
				<Button onClick={() => {handleChangeGroup(2)}} style={groupMenu === 2 ? styleActive : {}} className="right-button" variant="text">Genesis NFT Farm</Button>
			</GroupButtom>
			{renderTab()}
		</>
	)
