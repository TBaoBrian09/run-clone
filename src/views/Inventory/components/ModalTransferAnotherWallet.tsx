...
import { useTransferAnotherWallet } from "../hook/useSend"
...
const ModalTransferAnotherWallet: React.FC<Props> = ({ onDismiss, nftId, boxType }) => {
    ...
    const { handleTransferToAnotherWallet, requested, pendingTx, isClose } = useTransferAnotherWallet( targetWallet, nftId, onRefresh)
        ...
        (
          <WrapBodyNft>
              ...
              <Flex width="100%" mt="10px">
                  <Text>{t("You won't be able to take back the NFT after the transaction")}</Text>
              </Flex>           
                <CustomButton
